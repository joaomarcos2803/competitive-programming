-- https://www.beecrowd.com.br/judge/en/problems/view/2997

-- Exercício também parecido com o 2989, só foi necessário alterar
-- um pouco a query principal.

-- O beecrowd sugere utilizar a função ROUND para arredondar 
-- os valores, mas como os resultados que são iguais a 0 não possuem
-- casas decimais no resultado esperado, foi necessário não utilizá-lo.
...
SELECT
	...
	gs.gross_salary AS "Salario Bruto",
	d.discounts AS "Total Desconto",
	gs.gross_salary - d.discounts AS "Salario Liquido"
